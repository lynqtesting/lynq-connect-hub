-- First delete dependent tweak_requests that reference the legacy questions
DELETE FROM public.tweak_requests 
WHERE question_id IN (
  SELECT id FROM public.tweakable_questions 
  WHERE title IN (
...
-- Now delete the legacy tweakable_questions
