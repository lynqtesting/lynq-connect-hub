    ...
    >
      ...
      <div className="flex items-center justify-between">
        ...
        <InfoTooltip
          ...
          description="Topics where learners struggle the most, based on low scores, retries, or help signals."
        />
      </div>
        ...
        {items.map((item, index) => {
          ...
          return (
            ...
            >
              ...
              <span className="text-[10px] md:text-[11px] font-semibold text-text-secondary bg-bg-surface-hover px-2 py-1 rounded-lg whitespace-nowrap">
                {item.metricLabel}
              </span>
            </motion.div>
          );
